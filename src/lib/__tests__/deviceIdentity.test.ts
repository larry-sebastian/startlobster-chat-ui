...
describe('buildDeviceAuthPayload', () => {
  ...
  it('builds v1 payload without nonce', () => {
    ...
    expect(result).toBe(
      'v1|abc123|startlobster-xyz|webchat|operator|operator.chat,operator.admin|1700000000000|mytoken',
    );
  });
  ...
  it('builds v2 payload with nonce', () => {
    ...
    expect(result).toBe(
      'v2|abc123|startlobster-xyz|webchat|operator|operator.chat,operator.admin|1700000000000|mytoken|nonce42',
    );
  });
  ...
  it('handles null token', () => {
    ...
    expect(result).toBe(
      'v1|abc123|startlobster-xyz|webchat|operator|operator.chat,operator.admin|1700000000000|',
    );
  });
  ...
  it('handles empty scopes', () => {
    ...
    expect(result).toBe(
      'v1|abc123|startlobster-xyz|webchat|operator||1700000000000|mytoken',
    );
  });
  ...
  it('handles single scope', () => {
    ...
    expect(result).toBe(
      'v1|abc123|startlobster-xyz|webchat|operator|operator.chat|1700000000000|mytoken',
    );
  });
